...
export default function WebsiteDetail() {
  ...
  useEffect(() => {
    fetchWebsiteDetail();
  }, [id, dateRange, aggregationMode]); // Watch dateRange AND aggregationMode!
  ...
  return (
    <div className="min-h-screen bg-gray-900 -m-6 p-6">
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 mb-6">
        ...
        {/* Smart Data Warning */}
        {aggregationMode !== 'auto' && processedChartData.length > 200 && (
          <div className="mb-4 p-3 bg-orange-500/10 border border-orange-500/50 rounded-lg flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-orange-300 text-xs mt-1">
                Showing {processedChartData.length} data points. Chart may appear cluttered. Consider using "Auto" mode or a larger aggregation interval for better visualization.
              </p>
            </div>
          </div>
        )}
