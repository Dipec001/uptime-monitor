...
class WebsiteAdmin(admin.ModelAdmin):
    list_display = ("name", "url", "user", "check_interval", "is_active", "is_down", "next_check_at", "created_at")
    list_filter = ("is_active", "is_down", "check_interval", "created_at")
    search_fields = ("name", "url", "user__username", "user__email")
    autocomplete_fields = ("user",)
    ordering = ("-created_at",)
    readonly_fields = ("created_at", "last_downtime_at", "last_recovered_at", "next_check_at")


@admin.register(UptimeCheckResult)
class UptimeCheckResultAdmin(admin.ModelAdmin):
    list_display = ("website", "status_code", "response_time_ms", "checked_at", "is_passed")
...
class AlertAdmin(admin.ModelAdmin):
    list_display = ("website", "alert_type", "is_active", "retry_count", "last_sent_at", "created_at")
...
class NotificationPreferenceAdmin(admin.ModelAdmin):
    list_display = ("user", "website", "method", "target", "is_active", "created_at")
