...
# def notify_website_users(website, alert_type):
#     """Notify users based on their preferences for a given website and alert type."""
...
#             logger.warning("WhatsApp alerts not implemented yet.")
...
#             notify_website_users(website, "downtime")
...
#                 last_sent_at=now()
#             )
#             notify_website_users(website, "recovery")
