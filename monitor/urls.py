...
urlpatterns = [
    ...
    path('notifications/test_email/', views.TestEmailNotificationView.as_view(), name='test-email-notification'),
    ...
    path('alerts/bulk_create/', views.BulkCreateAlertsView.as_view(), name='bulk-create-alerts'),
