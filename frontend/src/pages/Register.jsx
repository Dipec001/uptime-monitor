      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-gray-800/50 backdrop-blur border border-gray-700 rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-center text-gray-400 mb-6">
            Join thousands monitoring their sites
          </p>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 bg-gray-700 text-white border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400"
                  required
                  disabled={loading}
                />
                <button
